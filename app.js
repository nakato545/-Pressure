...
// ── 定数 ──
const GEMINI_API_KEY = 'AQ.Ab8RN6KDUhXSn2eFWocMgtqP6e0Ie3sBoeFDm1r5TcdabpHjhg';
...
async function getDailyAdvice(level, cur, diff3, weatherCode, temp) {
  ...
  const cachedText = localStorage.getItem('aiAdviceText');
  if (localStorage.getItem('aiAdviceDate') === todayStr && cachedText) {
